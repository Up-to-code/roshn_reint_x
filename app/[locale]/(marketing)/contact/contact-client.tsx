...
import type { ContactUsSection } from "@/types/home-page";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto max-w-3xl text-lg font-light leading-relaxed text-muted-foreground md:text-xl">
              {locale === "ar"
                ? "عذراً، صفحة الاتصال غير متاحة حالياً."
                : "Sorry, the contact page is currently unavailable."}
            </p>
          </div>
        </div>
      </section>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                      <label
                        className={`text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 ${isRTL ? "text-right" : ""}`}
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {locale === "ar"
                        ? "يجب أن تكون الرسالة على الأقل 2 أحرف"
