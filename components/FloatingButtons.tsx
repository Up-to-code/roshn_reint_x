"use client";
// Fixed syntax error by wrapping button in div for positioning
  ...
  return (
    ...
    >
      <button
        ...
        className="group relative flex items-center justify-center overflow-hidden rounded-full bg-[#006D5B] p-4 text-white shadow-2xl transition-all duration-500 hover:scale-110 hover:shadow-[0_20px_60px_rgba(0,109,91,0.4)]"
        aria-label={isRTL ? "راسلنا على واتساب" : "WhatsApp us"}
      >
